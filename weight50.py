...
Data_pt1 = pd.read_csv('20201007-151001.csv', header=0)
Data_pt2 = pd.read_csv('20201007-151339.csv', header=0)
Data_pt3 = pd.read_csv('20201007-151627.csv', header=0)
Data_pt4 = pd.read_csv('20201007-151909.csv', header=0)
# ---------------------Data Separately-----------------------------
Data_pt1 = pd.DataFrame(Data_pt1)
Data_25 = Data_pt1[0:1700]
Data_50 = Data_pt1[1700: len(Data_pt1)]
...
Data_pt2 = pd.DataFrame(Data_pt2)
Data_75 = Data_pt2[0:1800]
Data_100 = Data_pt2[1800: len(Data_pt2)]
...
Data_125 = Data_pt3[0:1020]
Data_150 = Data_pt3[1020: len(Data_pt3)]
...
Data_175 = Data_pt4[0:2200]
Data_200 = Data_pt4[2200: len(Data_pt4)]
