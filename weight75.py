...
Data_pt1 = pd.read_csv('20201007-143445.csv', header=0)
Data_pt2 = pd.read_csv('20201007-143807.csv', header=0)
Data_pt3 = pd.read_csv('20201007-144051.csv', header=0)
Data_pt4 = pd.read_csv('20201007-144255.csv', header=0)
# ---------------------Data Separately-----------------------------
...
Data_pt2 = pd.DataFrame(Data_pt2)
Data_75 = Data_pt2[0:1700]
Data_100 = Data_pt2[1700: len(Data_pt2)]
...
Data_125 = Data_pt3[0:900]
Data_150 = Data_pt3[900: len(Data_pt3)]
...
Data_175 = Data_pt4[0:1050]
Data_200 = Data_pt4[1050: len(Data_pt4)]
