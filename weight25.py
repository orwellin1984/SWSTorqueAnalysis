...
Data_pt1 = pd.read_csv('20201007-140150.csv', header=0)
Data_pt2 = pd.read_csv('20201007-140843.csv', header=0)
Data_pt3 = pd.read_csv('20201007-141555.csv', header=0)
Data_pt4 = pd.read_csv('20201007-142124.csv', header=0)
# ---------------------Data Separately-----------------------------
Data_pt1 = pd.DataFrame(Data_pt1)
Data_25 = Data_pt1[0:5000]
Data_50 = Data_pt1[5000: len(Data_pt1)]
...
Data_75 = Data_pt2[0:3100]
Data_100 = Data_pt2[3100: len(Data_pt2)]
...
Data_125 = Data_pt3[0:3200]
Data_150 = Data_pt3[3200: len(Data_pt3)]
...
Data_175 = Data_pt4[0:3250]
Data_200 = Data_pt4[3250: len(Data_pt4)]
